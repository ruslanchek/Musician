<?php /* Smarty version Smarty 3.1.4, created on 2014-01-20 14:33:56
         compiled from "/Volumes/Black/Users/Ruslan/Sites/sdnfull/admin/templates/system/fields_editor/url.tpl" */ ?>
<?php /*%%SmartyHeaderCode:124628192852dcfb9400be51-54876999%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f21c49365396406ae91e4993fbb22edf6fa93c1a' => 
    array (
      0 => '/Volumes/Black/Users/Ruslan/Sites/sdnfull/admin/templates/system/fields_editor/url.tpl',
      1 => 1389999538,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '124628192852dcfb9400be51-54876999',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52dcfb945f0e3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52dcfb945f0e3')) {function content_52dcfb945f0e3($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['default']->value){?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_label');?>
    			...
    			<td class="content_col">
    				<?php if ($_smarty_tpl->tpl_vars['new']->value){?>
			            <input class="textfield" type="text" value="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_editor_tools_textfield_url');?>
...
<?php }?>" />
            ...
            <tr>
    			<td class="label_col">
    				<label for="mode_<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_mode');?>
</label>
    			</td>
    			<td class="content_col">
                    <label class="radio_label" title="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_mode_full_help');?>
">
                        <input value="1" type="radio" <?php if ($_smarty_tpl->tpl_vars['item']->value['mode']=='1'||!$_smarty_tpl->tpl_vars['item']->value['mode']){?>checked="checked"<?php }?> name="mode**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
                        <?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_mode_full');?>

                    </label>

                    <label class="radio_label" title="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_mode_part_help');?>
">
                        <input value="2" type="radio" <?php if ($_smarty_tpl->tpl_vars['item']->value['mode']=='2'){?>checked="checked"<?php }?> name="mode**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
                        <?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_mode_part');?>
...
<?php }?>" />
        ...
        <input type="hidden" value="url" name="type**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
